<?php $carts = $cartItems ?>
<?php $total = 0; ?>
<?php $voucher = isset($_SESSION['voucher']) ? 1 - $_SESSION['voucher'][0]['endow'] : 1 ?>
<?php foreach ($carts as $item): ?>
    <?php $total += $item['Gia'] * $item['SL']; ?>
<?php endforeach; ?>
<?php $shipping = $total > 39 ? 0 : number_format(38, 2); ?>
<?php $prevTotal = number_format($total + $shipping, 2); ?>
<?php $estiamtedTotal = number_format(($total + $shipping) * $voucher, 2); ?>
<?php unset($_SESSION['voucher']) ?>
...
<div class="page-order-container">
        ...
        <div class="page-order-checkout">
            ...
            <div class="order-checkout">
                ...
                <div class="render-shipping-order">
                    <p>
                        All orders require up to 3 business days of processing time to be picked, packed and prepared
                        for shipping. Kindly note that fulfillment times may vary during peak periods such as
                        after/during product launches, holidays and special promotions.
                    </p>
                    <p>
                    ...
                    <div class="order-checkout-shipping">
                        ...
                        <form method="post" class="order-checkout-shipping-form">
                            <input type="text" name="HoTen" value="<?= $user_info['HoTen'] ?>" placeholder="Full Name"
                                required>
                            <input type="text" name="shipping_address" value="<?= $user_info['DiaChi'] ?>"
            ...
            <div class="order-checkout-payment">
                ...
                <div style="display: none;" class="render-payment-order">
            ...
            <div class="order-checkout-review">
                ...
                <div class="render-review-order">
                    ...
                    <p>
                        ...
                        *By checking the above box you are agreeing to receive email communications from DECIEM Inc.,
                        its affiliates, brands (The Ordinary, NIOD and LOoPHA) and/or marketing partners. This can be
                        changed at any time. Please refer to our Privacy Policy and Terms of Use for more details or
                        Contact Us.
                    </p>
                    <p>
    ...
    <script
        src="https://www.paypal.com/sdk/js?client-id=Aah1aCIFNDru_qqlCmL3Fl42XUfKPyBxkV6xiBy8KLDCIUNqaKfP5A1gr3EBfmZHlVC_29KKj-XXcx0U&currency=USD"></script>
    <script>
        paypal.Buttons({
    ...
    <div class="page-order-summary-container">
        <div class="page-order-summary">
            ...
            <div class="order-summary-row-total">
                ...
                <strong style=<?= $estiamtedTotal!=$prevTotal ? "text-decoration:line-through;opacity:50%;margin-left:130px;":"" ?>><?= $prevTotal ?> USD</strong>
                <?php if($estiamtedTotal!=$prevTotal): ?>
            ...
            <form method="post" action="/The-Ordinary/voucher" class="voucher">

                <input name="voucher" type="text" placeholder="Enter your voucher code">
                <button type="submit" class="apply-voucher-btn">Apply</button>
            ...
            <p class="order-disclaimer">
                The safety of our customers is a key priority, which is why we are committed to the prevention of the
                sale and distribution of counterfeit products or products sold through unauthorized retail channels.
                Please note that products and services available via DECIEM are for personal use only. We do not permit
                the reselling of our products or services, as noted in our <a href="#">Terms and Conditions</a>. If you
                are not satisfied with your purchase, you may return it for a full refund within one year of purchase.
                Kindly note that DECIEM does not cover the costs of return shipping. Please explore our <a
                    href="#">Return Policy</a> for more details.
            </p>
