        ...
        <div class='footer-container'>
            <div class='footer-col'>
                ...
                <div class='content-info'>
                    <h3>Be in a know</h3>
                    <p class='content-info-description' style='padding-bottom: 15px;'>Subscribe to receive science-backed tips, access to special offers, and new innovations.</p>
                    <form>
                        <input type='email' class='form-email' placeholder='Enter your email'>
                        <i class='fa-solid fa-angle-right icon' style='color: gray;'></i>
                    </form>
                    <p style='padding:15px 0 15px 0;'>*By providing your email address you are agreeing to receive email communications from DECIEM Inc., its affiliates, brands (The Ordinary, NIOD, and LOoPHA) and/or marketing partners. This can be changed at any time. Please refer to our Privacy Policy and Terms of Use for more details or Contact Us.</p>
